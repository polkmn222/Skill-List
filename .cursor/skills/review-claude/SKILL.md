---
name: review-claude
description: Use in Cursor when the user asks for Claude Code review or a Codex/Claude second-pass review; delegates to the shared review-agents scripts.
---
