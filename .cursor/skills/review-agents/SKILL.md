---
name: review-agents
description: Use in Cursor when code changes need a second-pass review from Claude Code, Codex, or both, using the shared project review scripts and cost logging.
---
